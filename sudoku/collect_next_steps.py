...
from .helpers import check_blocks_is_valid, collect_puzzle_block, collect_puzzle_blocks, compute_block_index, puzzle_copy
...
class CollectNextSteps:
    ...
    def collect(self, puzzle: Puzzle, row_ix: int, col_ix: int, next_row_ix: int, next_col_ix: int) -> List[Tuple[Puzzle, int, int]]:
        return self.collector(puzzle, row_ix, col_ix, next_row_ix, next_col_ix)


def collect_valid_options(puzzle: Puzzle, row_ix: int, col_ix: int, next_row_ix: int, next_col_ix: int) -> List[Tuple[Puzzle, int, int]]:
    row = puzzle[row_ix]
...
def collect_valid_blocks(puzzle: Puzzle, row_ix: int, col_ix: int, next_row_ix: int, next_col_ix: int) -> List[Tuple[Puzzle, int, int]]:
    nexts = []
